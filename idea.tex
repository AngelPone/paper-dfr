...
\subsubsection{Simulation setup 2}
...
Values of the $k$ days with the biggest probabilities were set to $1$, and others were set to $0$. $k$ is the value of corresponding weekly observation.
...
\subsubsection{Simulation results 2}

Table~\ref{tab:sim_temporal_res_point} summarizes the point forecast performance of the stepwise reconciliation model, compared with base forecasts and bottom-up method.
...
& Bottom Level & Total Level & Bottom Level & Total Level\\
\cmidrule(lr){2-3}\cmidrule(lr){4-5}
Base      & $0.498$ & $2.77$ & $\textbf{0.480}$ & $2.71$\\
Bottom-Up & $0.498$ & $2.80$ & $\textbf{0.480}$ & $2.70$\\
SDFR      & $\textbf{0.493}$ & $\textbf{2.71}$ & $0.482$ & $\textbf{2.66}$\\
\bottomrule
\end{tabular}
\end{table}

Table~\ref{tab:sim_temporal_res_dist} summarizes the probabilistic forecast performance of stepwise reconciliation model, compared with base forecasts and bottom-up method.
...
& Bottom Level & Total Level & Hierarchy \\
\cmidrule(lr){2-4}
Base      & $0.498$ & $\textbf{0.821}$ &  $-$ \\
Bottom-Up & $0.498$ & $0.836$ &  $0.991$ \\
SDFR      & $\textbf{0.488}$ & $0.825$ & $\textbf{0.989}$ \\
\bottomrule
\end{tabular}
\end{table}
