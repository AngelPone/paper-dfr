...
\begin{enumerate}
  ...
  However, it is possible to incorporate rounding in the process of producing base forecasts. As we stated in our paper, our framework allows for arbitrary univariate predictive distribution, including those produced by rounding non-integer forecasts.}
  ...
  \RE{Thank you for highlighting this issue. Indeed, we also did not find studies about the cost of rounding non-integer forecasts. We have now removed this sentence ``''.}
  \textcolor{red}{
    1. Rounding multivariate predictive distribution is not that easy.
    2. Benchmark: rounding only bottom-level series
    }
