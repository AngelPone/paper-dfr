...
\begin{tikzpicture}
    ...
    \fill[gray!20] (4.1, 0) rectangle ++(1, 0.3);

    \draw[draw=black] (0, -0.6) rectangle ++(4.5, 0.3);
    \fill[gray!20] (4.6, -0.6) rectangle ++(1, 0.3);

    \draw[draw=black] (0, -1.2) rectangle ++(5, 0.3);
    \fill[gray!20] (5.1, -1.2) rectangle ++(1, 0.3);

    \draw[draw=black] (0, -1.8) rectangle ++(5.5, 0.3);
    \fill[gray!20] (5.6, -1.8) rectangle ++(1, 0.3);

    % \node[text centered,anchor=south west, minimum height=0.3] at (0, -2.4) {\large $\dots$};

    \draw[draw=black] (0, -2.4) rectangle ++(6, 0.3);
    \fill[gray!20] (6.1, -2.4) rectangle ++(1, 0.3);

    \draw[draw=black] (0, -3) rectangle ++(6.5, 0.3);
    \fill[gray!20] (6.6, -3) rectangle ++(1, 0.3);

    \draw[draw=black] (0.5, -3.6) rectangle ++(1, 0.3);
    \node[anchor=south west] at (1.6, -3.75) {\small Training};

    \fill[gray!20] (4, -3.6) rectangle ++(1, 0.3);
    \node[anchor=south west] at (5.1, -3.75) {\small Forecasting};
